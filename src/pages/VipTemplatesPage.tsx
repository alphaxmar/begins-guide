    ...
    <div className="py-12 max-w-6xl mx-auto px-4">
      <div className="text-center mb-8">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <h1 className="text-3xl font-bold">เทมเพลตทั้งหมดสำหรับ VIP</h1>
        </div>
        <p className="text-muted-foreground">
          ดาวน์โหลดเทมเพลตทั้งหมดได้ไม่จำกัดสำหรับสมาชิก VIP
        </p>
      ...
      {!templates || templates.length === 0 ? (
        <div className="text-center py-12 border-2 border-dashed rounded-lg bg-muted/5">
          ...
          <h3 className="text-lg font-semibold mt-4">ยังไม่มีเทมเพลต</h3>
          <p className="text-muted-foreground mt-1">เทมเพลตจะปรากฏที่นี่เมื่อมีการเพิ่มเข้ามา</p>
        </div>
      ) : (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground line-through">
                    ราคาปกติ {template.price.toLocaleString()} บาท
                  </span>
...
export default VipTemplatesPage;
